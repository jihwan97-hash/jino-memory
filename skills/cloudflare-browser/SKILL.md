...
```bash
# Screenshot
node /Users/astin/.jinobot/clawd/skills/cloudflare-browser/scripts/screenshot.js URL output.png

# Read a web page (renders JS, extracts clean text)
node /Users/astin/.jinobot/clawd/skills/cloudflare-browser/scripts/read-page.js URL [--max-chars 3000] [--html]

# Video (multi-URL)
node /Users/astin/.jinobot/clawd/skills/cloudflare-browser/scripts/video.js "url1,url2" output.mp4
```
